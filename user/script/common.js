...
function chkStunum(stunum){
	var myDate = new Date();
	var year = myDate.getFullYear();
	var str=stunum.substring(4,stunum.length);
	if(stunum.length==10&&stunum.substring(0,4)>2015){
		return true;
	}else if(stunum.length==12&&stunum.substring(0,4)<2016){
		return true;
	}else{
		return false;
	}
